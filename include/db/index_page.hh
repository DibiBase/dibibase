...
public:
  IndexPage(std::map<std::unique_ptr<catalog::Data>, off_t> sort_keys,
  ...
  const std::map<std::unique_ptr<catalog::Data>, off_t> &sort_keys() const {
    return m_sort_keys;
  }
...
private:
  ...
  std::map<std::unique_ptr<catalog::Data>, off_t> m_sort_keys;
