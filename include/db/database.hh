...
public:
  ...
  Database(std::string directory_path) : m_directory_path(directory_path) {}
  ...
  catalog::Record read_record(std::string table_name, catalog::Field);

  void flush_metadata();

private:
  // Assuming path of metadata: m_directory_path/metadata.md
  void open_metadata();
