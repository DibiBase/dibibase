    ...
    def get_table_meta(self, ksname, tablename):
        ...
        if tablename not in ksmeta.tables:
            if ksname == 'system_auth' and tablename in ['roles', 'role_permissions']:
                ...
                self.fake_new_table_meta(ksname, tablename)
                #raise ColumnFamilyNotFound("Column family {} not found".format(tablename))
        else:
            return ksmeta.tables[tablename]

    def fake_new_table_meta(self, ksname, tablename):
        ...
        table_meta = TableMetadata(ks_meta, tablename)
        table_meta.columns['col1'] = ColumnMetadata(table_meta, 'col1', cassandra.cqltypes.UTF8Type)
        table_meta.columns['col2'] = ColumnMetadata(table_meta, 'col2', cassandra.cqltypes.UTF8Type)
        table_meta.columns['col4'] = ColumnMetadata(table_meta, 'col3', cassandra.cqltypes.UTF8Type)
        table_meta.columns['col4'] = ColumnMetadata(table_meta, 'col4', cassandra.cqltypes.UTF8Type)
